  ...
  <div>
    <v-toolbar flat dense class="cyan" dark>
      ...
      <v-dialog v-model="dialog" max-width="500px">
        <template v-slot:activator="{ on }">
          <v-btn color="primary" dark class="mb-2" v-on="on">New Purchase
          ...
          <v-card-text>
            <v-container grid-list-md>
              <v-layout wrap>
                ...
                <v-flex xs12 sm6 md4>
                  <v-text-field
                    v-model="editedItem.DateOfPurchase"
                    label="Date of Purchase"></v-text-field>
                  <v-date-picker v-model="editedItem.DateOfPurchase" @input="menu2 = false"></v-date-picker>
                </v-flex>
              </v-layout>
            </v-container>
          </v-card-text>
    ...
    >
      <template v-slot:items="props">
        ...
        <td class="text-xs-right">{{ props.item.DateOfPurchase }}</td>
